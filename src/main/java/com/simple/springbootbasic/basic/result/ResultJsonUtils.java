...
public class ResultJsonUtils<T> {
    ...
    public ResultJsonData<T> success(List<T> list,Integer count){
        return new ResultJsonData(ResponseCode.SUCCESS.getCode(),ResponseCode.SUCCESS.getMessage(),list,count);
    }
